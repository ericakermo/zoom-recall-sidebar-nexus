...
const ZoomIcon = () => <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  return <Popover>
      ...
      <PopoverContent className="w-80 p-6 h-96" align="start" side="right" sideOffset={10}>
        <div className="space-y-6">
          {/* Title */}
          <h3 className="leading-tight font-medium text-3xl text-[#111211]/70">{meeting.title}</h3>
          ...
          <div className="flex items-center gap-6">
            ...
            <div className="flex items-center gap-5 px-[8px]">
              <ZoomIcon />
              <Button onClick={handleJoinMeeting} className="bg-blue-600 hover:bg-blue-700 text-white py-50 px-[25px] text-xs bg-[0B5CFF] rounded-full">
                Join Zoom Meeting
              </Button>
            </div>
            
            {/* Copy Button */}
            <Button variant="outline" size="sm" onClick={handleCopyUrl} className="ml-4 h-8 w-8 p-0 mx-[50px] text-sm">
